...
class FLL2024SubmergedMissions(FLLBaseLib):
    ...
    async def mission_moving_ship_30_20(self):
        ...
        await self.move_forward(50,600,steer=-20)
        await self.move_forward(70,600,steer=-25)
        await self.move_backward(100,600,steer=-5)
    ...
    async def race9(self):
        await self.go_between_launch_zones()
        pass
