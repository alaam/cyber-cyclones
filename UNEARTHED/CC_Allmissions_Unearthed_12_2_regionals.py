...
class FLL2025UnearthedMissions(FLLBaseLib):
    ...
    async def mission_12_SO_30(self):
        ...
        await self.move_backward(12,velo=700)
        await self.second_arm_up(degree=180)
        await self.move_backward(5,velo=500)
        await self.turn_left(12,speed=100)
        await self.move_forward(20,velo=500)
        await self.move_forward(20,velo=100,steer=4)
        await self.move_backward(53,velo=700)
        pass
    ...
    async def mission_1_SB_30_2_MR_30(self):
        await self.first_arm_reset()
        await self.second_arm_reset()
        await self.second_arm_down(degree=7,speed=100)
        ...
        await self.move_backward(5,velo=400)
        await self.first_arm_up(degree=-180,speed=100)
        await self.second_arm_down(degree=180,speed=100)
        await self.move_forward(5,velo=100)
        await self.second_arm_up(degree=220,speed=200)
...
async def mission_03_13_ME_SR_30_30(self):
    ...
    await self.move_backward(16,velo=700)
    await self.turn_left(90)
    await self.move_backward(78,velo=800)
    pass
    
    ### If we have time at the end run this..
    ##### mission 13 statue raise
async def mission_13_SR_10(self):
    await self.move_forward(7,velo=200)
    await self.turn_right(80,speed=100)
    await self.move_forward(43,velo=400)
    await self.turn_left(38,speed=100)
    await self.first_arm_down(degree=300,speed=300)
    await self.first_arm_up(degree=180,speed=700)
    await self.first_arm_down(degree=300,speed=200)
    await self.sleep(10)
    await self.move_forward(5,velo=700)
    pass
    ...
    ## Run this mission if brush is standing up...
    ###race xx####
    ### Alignement towards forum
    async def mission_15_forum_10(self):
        await self.move_forward(45,velo=700)
        await self.move_backward(45,velo=700)

    ### Try this to see if it possible to have any success.
     ### Race yy####
    ### Alignment right side 4 blocks to tip####
    ...
    # async def mission_5_WL_6_Forge_SB_60_org(self):
    #    await self.first_arm_reset()
    #    await self.second_arm_reset()
    #    await self.second_arm_up(degree=15,speed=200)
    #    #getting ready for forge
    ...
    async def mission_5_WL_6_Forge_SB_60(self):
        await self.first_arm_reset()
        await self.second_arm_reset()
        await self.second_arm_up(degree=6,speed=200)
    #getting ready for forge
        await self.turn_left(14)
        await self.move_forward(62.3,velo=600)
        await self.second_arm_down(degree=2,speed=200)

     #preping to move the lever 
        await self.turn_right(35,speed=700)
        await self.turn_left(60,speed=1100)    
    #getting ready for who lives here
        await self.second_arm_down(degree=10,speed=200) 
        #getting ready to move the lever for who live there
        await self.move_forward(4,steer=0)
        await self.turn_right(5,speed=700)
        await self.turn_left(95)
    #getting ready for tip your scale
        await self.move_backward(6)
        await self.turn_left(38)
        await self.second_arm_up(degree=80,speed=200)
        await self.move_forward(33)
        await self.turn_left(100,speed=200)
        await self.first_arm_up(45) 
        await self.move_forward(5,velo=700)
        await self.first_arm_down(80)
        await self.first_arm_up(80)
        ...
        await self.first_arm_down(80)
        await self.first_arm_up(80)
        await self.move_backward(6.5,velo=700)
        await self.turn_right(115)
        await self.move_backward(90,velo=800)
    ...
    async def mission_7_HL_HeavyLift_30(self):
     ...
     await self.turn_right(90,speed=100)
     await self.move_forward(33,velo=700)
     await self.turn_left(75,speed=100)
     await self.move_forward(25,velo=200)
     await self.turn_left(25,speed=100)
     await self.move_forward(20,velo=200,steer=-5)
     await self.turn_left(5,speed=100)
     await self.move_forward(19,velo=900)
     await self.turn_left(15,speed=200)
     await self.first_arm_down(50)
     await self.turn_left(80)
     await self.first_arm_up(degree=90,speed=100)
     await self.move_backward(80,velo=700)

    # async def mission_7_HL_HeavyLift_30_try(self):
    #     await self.first_arm_reset()
    #     #await self.second_arm_up(degree=150,speed=200)
    #     await self.move_forward(7,velo=700)
    #     await self.turn_right(75,speed=100) #90
    #     await self.move_forward(41,velo=300)
        
    #     await self.turn_left(60,speed=100)
    #     await self.move_forward(20,velo=300,steer=-1)

    #     await self.turn_left(25,speed=100)
    #     await self.move_forward(5,velo=200,steer=-3)

    #     return
    #     await self.turn_left(30,speed=100)
    #     #await self.move_forward(40,velo=400)
    #     return
    #     await self.turn_left(10,speed=100)
    #     await self.move_forward(19,velo=900,steer=-5)
        
    #     #await self.first_arm_down(50)
    #     #await self.first_arm_up(10)
    #     await self.turn_left(30,speed=200)
    #     await self.first_arm_down(40)
    ...
    async def mission_10_Send_tip(self):
     await self.turn_right(19)
     await self.move_forward(44.2,velo=1000)
     await self.second_arm_down(180)
     await self.turn_left(40)
     await self.turn_right(20)
     await self.move_forward(35,velo=1000)
     await self.turn_right(50)
     await self.move_forward(25,velo=900)
     await self.second_arm_up(180)
     await self.turn_left(40)
     await self.move_forward(90,velo=1000)
    ...
    async def mission_09_WoS_30(self):
     ...
     await self.move_backward(20,velo=400)
     await self.sleep(1)
     await self.second_arm_up(degree=15,speed=40)
     await self.move_backward(6,velo=50)
     await self.second_arm_down(55)
     await self.turn_right(20)
     await self.turn_left(60,speed=1100)
     await self.second_arm_up()
     await self.turn_right(50)
     await self.move_backward(50,velo=1000)
    ...
    async def race5(self):
        await self.mission_10_Send_tip()
        pass
    async def race6(self):
        await self.mission_10_Send_0()
        pass
    async def race7(self):
        await self.mission_12_SO_30()
        pass

    async def race8(self):
        await self.mission_1_SB_30_2_MR_30()
        pass

    async def race9(self):
        await self.mission_03_13_ME_SR_30_30()
        pass
        
    async def race10(self):
        await self.mission_15_forum_10()
        pass
...
async def main():
    ...
    test=False
    race1=False  #HeavyLift
    race2=True #Fodge/Whats on Sale/ Tip the scale
    race3=False #Silo
    race4=False #Whats on Sale
    race5=False # send the robot with Tip
    race6=False # send the robot
