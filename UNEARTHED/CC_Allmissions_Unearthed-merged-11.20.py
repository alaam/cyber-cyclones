...
#        while ed or degrees:
    ...
    async def _arm_reset_left_left(self,port,angle_overdrive=359,initial_postition_deg=230,speed=700):
        await self._arm_reset(port,angle_overdrive,initial_postition_deg,speed)
...
##### race2    #######
    async def mission_03_13_ME_SR_30_30(self):
     await self.first_arm_reset()
     await self.move_forward(71,velo=700)
     await self.turn_right(117)
     await self.first_arm_down(degree=60,speed=250)
     await self.move_forward(19,velo=700 )
     await self.first_arm_up(degree=70,speed=100)
     await self.sleep(10)
     await self.first_arm_down(degree=80,speed=100)
     await self.turn_right(90)
     await self.move_forward(6,velo=700)
     await self.first_arm_up(degree=80)
    ...
    async def mission_8_Silo_30(self):
        ...
        await self.second_arm_up(degree=180)
        await self.second_arm_down(degree=180)
        await self.second_arm_up(degree=180, speed=1100)
        await self.second_arm_down(degree=180)
        await self.second_arm_up(degree=180, speed=1100)
        await self.second_arm_down(degree=180)
        await self.move_backward(38,velo=700)

    async def mission_9_SA_30(self):
            await self.first_arm_reset()
            await self.move_forward(51,velo=700)
            await self.first_arm_down(50)
            await self.move_backward(9,velo=700)
