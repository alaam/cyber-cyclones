...
class FLL2025UnearthedMissions(FLLBaseLib):
    ...
    #### This ist just arm reset race 0##
    ## Run this race 0 holding robot in hand this to aviod the error running this keepint it on board###
...
##### 17 secs
    ...
    async def race7(self):
        await self.mission_4_CR_30()
        pass
    
    async def race8(self):
        await self.mission_1_SB_10()
        pass
